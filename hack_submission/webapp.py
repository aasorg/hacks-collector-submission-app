...
HACKLIST_REPO = 'aasorg/hacks-collector'
...
def create_file():
    ...
    aasevent = request.form['aasevent']
    ...
    if request.files['pic'].filename != "":
        ...
        files["{}/{}".format(aasevent, image_filename)] = content, 'base64'
    ...
    files['{}/{}'.format(aasevent, filename)] = make_file_contents(request, image_filename), 'utf-8'
    ...
    prbody = 'This is a PR auto-generated by a form to record information about the AAS {} hack "{}"'.format(aasevent, request.form['title'])
